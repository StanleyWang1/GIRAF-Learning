...
class SharedMemoryRingBuffer:
    ...
    @property
    def oldest_count(self) -> int:
        return max(0, self.count - self.buffer_size)
    ...
    def get_since(self, start_count: int) -> tuple[int, dict[str, np.ndarray]]:
        end_count = self.count
        return end_count, self.get_range(start_count, end_count)
